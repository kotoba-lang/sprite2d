...
(defn world->screen
  "Returns [sx sy k] — fns mapping world x/y to screen px for this scene/snapshot/viewport, plus the
   scale k. The same transform draw-2d! and draw-list use, exposed so the GPU path (kotoba.scene2d) can
...
(defn tree-scatter
  "Deterministic background tree scatter [[x y r]…] — the same seeded positions kotoba.sprite2d paints,
